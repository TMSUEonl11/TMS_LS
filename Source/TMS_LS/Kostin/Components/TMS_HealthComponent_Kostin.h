...
#include "TMS_HealthComponent_Kostin.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnDeathSignature_Kostin);

class UTMS_MovementData;

UCLASS( ClassGroup=(Custom), meta=(BlueprintSpawnableComponent) )
class TMS_LS_API UTMS_HealthComponent_Kostin : public UActorComponent
{
	GENERATED_BODY()

public:	
	// Sets default values for this component's properties
	UTMS_HealthComponent_Kostin();

public:
	UPROPERTY(BlueprintAssignable)
	FOnDeathSignature_Kostin OnDeath;
